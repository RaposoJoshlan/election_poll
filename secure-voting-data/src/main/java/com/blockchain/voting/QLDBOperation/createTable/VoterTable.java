 ...
 */
public class VoterTable implements CreateTable, CreateIndex {
    ...
    public void createTable() {
        QLDBConfig.getDriver().execute(txn -> {
            createTableSetup(txn, Constants.VOTER_TABLE_NAME);
        });
    }
    ...
    public void createIndex() {
        QLDBConfig.getDriver().execute(txn -> {
            createIndexSetup(txn, Constants.VOTER_TABLE_NAME, Constants.VOTER_ID_INDEX);
            createIndexSetup(txn, Constants.VOTER_TABLE_NAME, Constants.VOTER_GENDER);
            createIndexSetup(txn, Constants.VOTER_TABLE_NAME, Constants.VOTER_LOCATION);
