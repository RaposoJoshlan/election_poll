 ...
 */
public class VoteTable implements CreateTable, CreateIndex {
    ...
    public void createTable() {
        QLDBConfig.getDriver().execute(txn -> {
            createTableSetup(txn, Constants.VOTE_TABLE_NAME);
        });
    }
    ...
    public void createIndex() {
        QLDBConfig.getDriver().execute(txn -> {
            createIndexSetup(txn, Constants.VOTE_TABLE_NAME, Constants.VOTE_ID_INDEX);
            createIndexSetup(txn, Constants.VOTE_TABLE_NAME, Constants.VOTED_CANDIDATE_INDEX);
            createIndexSetup(txn, Constants.VOTE_TABLE_NAME, Constants.VOTE_ELECTION_INDEX);
