...
public class CandidateTable implements CreateTable, CreateIndex {
    ...
    public void createTable() {
        QLDBConfig.getDriver().execute(txn -> {
            createTableSetup(txn, Constants.CANDIDATE_TABLE_NAME);
        });
    }
    ...
    public void createIndex() {
        QLDBConfig.getDriver().execute(txn -> {
            createIndexSetup(txn, Constants.CANDIDATE_TABLE_NAME, Constants.CANDIDATE_NAME_INDEX);
            createIndexSetup(txn, Constants.CANDIDATE_TABLE_NAME, Constants.CANDIDATE_ID_INDEX);
        });
